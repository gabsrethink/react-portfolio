...
const ExperienceCard: React.FC<{ experience: ExperienceCardProps }> = ({
  ...
  return (
    <div
      onClick={handleClick}
      className="flex justify-center flex-row items-start hover-item rounded-lg hover:bg-gray-10/60 group p-4 max-sm:flex-col max-sm:hover:bg-transparent cursor-pointer"
    >
